...
![caskkit-banner-dark](https://github.com/user-attachments/assets/4d98ff85-0998-4bb9-81b4-2c63323ccd86)
...
- [`docs/ICON_EXTRACTION.md`](./docs/ICON_EXTRACTION.md) — how app icons are extracted from cask artifacts and published to the [`icons` branch](https://github.com/alielsokary/CaskKit/tree/icons).
...
A second daily cron (`.github/workflows/extract-icons.yml`) extracts original app icons from cask artifacts — downloaded, expanded without executing anything, and rendered to 256×256 PNGs. Icons live on the orphan [`icons` branch](https://github.com/alielsokary/CaskKit/tree/icons) (one PNG per cask token) and are served to CaskHub through jsDelivr's CDN:
